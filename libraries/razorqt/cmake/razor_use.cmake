...
#
#
# razor_set_default_value(VAR_NAME VAR_VALUE)
#
#
#
# The module defines the following definitions
#
#  -DRAZOR_SHARE_DIR     - This allows to install and read the configs from non-standard locations
#
#  -DRAZOR_ETC_XDG_DIR   - XDG standards expects system-wide configuration files in the
...
include_directories(${RAZOR_INCLUDE_DIRS})

#cmake_policy(SET CMP0005 NEW)
add_definitions(-DRAZOR_SHARE_DIR=\"${RAZOR_SHARE_DIR}\")
add_definitions(-DRAZOR_ETC_XDG_DIR=\"${RAZOR_ETC_XDG_DIR}\")
...
macro(razor_set_default_value VAR_NAME VAR_VALUE)
