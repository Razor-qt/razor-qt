...
void GlobalShortcutManager::connect(const QString& key, QObject* receiver, const char* slot)
{
    GlobalShortcutManager::connect(QKeySequence(key), receiver, slot);
}
...
void GlobalShortcutManager::disconnect(const QString& key, QObject* receiver, const char* slot)
{
    GlobalShortcutManager::disconnect(QKeySequence(key), receiver, slot);
}
