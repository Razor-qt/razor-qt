...
<div class=rzNav>
	...
	<input class="rzSearch" type="text" id="rzMSearchField" value="" accesskey="S"
               Qonfocus="searchBox.OnSearchFieldFocus(true)"
               Qonblur="searchBox.OnSearchFieldFocus(false)"
               onkeyup="search(this.value)"/>

	<div class="rzSearchResults" id="rzSearchResults" style="display: none;"></div>
	</div>
    -->
    <h1>API Lookup</h1>
    <ul>
...
<table cellspacing="0" cellpadding="0">
 ...
 <tr style="height: 56px;">
  <td id="projectlogo"><img alt="Logo" src="razor_logo_doxygen.png"/></td>
  <td style="padding-left: 0.5em;">
   <div id="projectname">Razor-qt&#160;<span id="projectnumber">0.3.99</span></div>
   <div id="projectbrief">Qt XDG implementation.</div>
  </td>
 </tr>
 </tbody>
</table>
