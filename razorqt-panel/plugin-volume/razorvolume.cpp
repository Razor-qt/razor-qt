        ...
        m_defaultSink(0)
{
    ...
    m_keyVolumeUp = GlobalKeyShortcut::Client::instance()->addAction(QString(), "/panel/volume_control/up", tr("Increase sound volume"), this);
    if (m_keyVolumeUp)
    {
    ...
    m_keyVolumeDown = GlobalKeyShortcut::Client::instance()->addAction(QString(), "/panel/volume_control/down", tr("Decrease sound volume"), this);
    if (m_keyVolumeDown)
    {
    ...
    m_keyMuteToggle = GlobalKeyShortcut::Client::instance()->addAction(QString(), "/panel/volume_control/mute", tr("Mute/unmute sound volume"), this);
    if (m_keyMuteToggle)
    {
